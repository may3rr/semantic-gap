...
# load negation words
negation_words = []
with open('../../resources/Chinese/others/negative/negationWords.txt', 'r', encoding='utf-8') as src:
    lines = src.readlines()
    for line in lines:
...
# load degree words
how_words_dict = dict()
with open('../../resources/Chinese/HowNet/intensifierWords.txt', 'r', encoding='utf-8') as src:
    lines = src.readlines()
    for line in lines:
...
with open('../../resources/Chinese/BosonNLP/BosonNLP_sentiment_score.txt', 'r', encoding='utf-8') as src:
    lines = src.readlines()
    for line in lines:
